...
class RecurringExpenseResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'recurringExpense';
    protected static ?string $pluralModelLabel ="المصروفات الدورية";
    protected static ?string $modelLabel="مصروفات دورية";
